...
* [JDBC API](https://docs.spring.io/spring-boot/docs/2.6.9/reference/htmlsingle/#data.sql)
* [Spring Batch](https://docs.spring.io/spring-boot/docs/2.6.9/reference/htmlsingle/#howto.batch)
